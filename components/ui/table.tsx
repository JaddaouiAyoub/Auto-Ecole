  ...
  return (
    <tr
      ...
      className={cn(
        ...
        "has-aria-expanded:bg-muted/40 data-[state=selected]:bg-primary/5",
        className
      )}
      {...props}
    />
...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-11 px-3 text-left align-middle text-[11px] font-semibold uppercase tracking-wider",
        "text-muted-foreground/80 whitespace-nowrap",
